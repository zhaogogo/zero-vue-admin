    ...
    <div>
        ...
        >
            <el-form-item prop="icon" style="width:100%">
                <i class="icon" :class="'el-icon-'+meta.icon" style="position: absolute; z-index: 9999; padding: 5px 10px; "></i>
                <el-select v-model="meta.icon" clearable filterable placeholder="请选择" style="padding:0 30px">
