...
type AlertRules struct {
	...
	Querys []AlertRuleQuery `gorm:"foreignKey:alert_rule_id"`
}

type AlertRuleLabel struct {
	Id          uint64 `gorm:"primaryKey;type:bigint(30) AUTO_INCREMENT"`
	AlertRuleId uint64 `gorm:"clumn:alert_rule_id"`
...
type AlertRuleQuery struct {
	...
	AlertRuleId uint64 `gorm:"clumn:alert_rule_id;type:bigint"`
	Query       string `gorm:"clumn:query;type:varchar(255)"`
}
