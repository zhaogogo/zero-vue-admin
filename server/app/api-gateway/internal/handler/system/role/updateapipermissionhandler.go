...
func UpdateAPIPermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateRoleAPIPermissionRequest
		...
		l := role.NewUpdateAPIPermissionLogic(r.Context(), svcCtx)
		resp, err := l.UpdateAPIPermission(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
