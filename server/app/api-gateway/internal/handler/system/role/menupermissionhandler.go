...
func MenuPermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RoleMenuPermissionRequest
		...
		l := role.NewMenuPermissionLogic(r.Context(), svcCtx)
		resp, err := l.MenuPermission(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
