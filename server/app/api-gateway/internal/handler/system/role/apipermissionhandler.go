...
func APIPermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RoleAPIPermissionRequest
		...
		l := role.NewAPIPermissionLogic(r.Context(), svcCtx)
		resp, err := l.APIPermission(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
