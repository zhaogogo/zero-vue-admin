...
func UpdateMenuPermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateRoleMenuPermissionRequest
		...
		l := role.NewUpdateMenuPermissionLogic(r.Context(), svcCtx)
		resp, err := l.UpdateMenuPermission(&req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
