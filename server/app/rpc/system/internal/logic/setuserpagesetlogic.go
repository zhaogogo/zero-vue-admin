...
type SetUserPageSetLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewSetUserPageSetLogic(ctx context.Context, svcCtx *svc.ServiceContext) *SetUserPageSetLogic {
	return &SetUserPageSetLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *SetUserPageSetLogic) SetUserPageSet(in *pb.SetUserPageSetRequest) (*pb.Empty, error) {
