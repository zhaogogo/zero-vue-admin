...
type AddUserAndUserRoleLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewAddUserAndUserRoleLogic(ctx context.Context, svcCtx *svc.ServiceContext) *AddUserAndUserRoleLogic {
	return &AddUserAndUserRoleLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *AddUserAndUserRoleLogic) AddUserAndUserRole(in *pb.AddUserAndUserRoleRequest) (*pb.Empty, error) {
